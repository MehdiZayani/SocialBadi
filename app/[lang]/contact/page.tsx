            ...
            <section className="py-10 bg-gray-100 sm:py-16 lg:py-24">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="max-w-2xl mx-auto text-center">
                        <h2 className="text-3xl font-bold leading-tight text-blue-500 sm:text-4xl lg:text-5xl">{translations.contactus}</h2>
                    ...
                    <div className="max-w-5xl mx-auto mt-12 sm:mt-16">
                        ...
                        <div className="mt-6 overflow-hidden bg-white rounded-xl">
                            <div className="px-6 py-12 sm:p-12">
                                <h3 className="text-3xl font-semibold text-center text-blue-500">{translations.contactform.sendusmessage}</h3>

                                <form action="#" method="POST" className="mt-14">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                                        <div>
                                            <label htmlFor="" className="text-base font-medium text-gray-900"> {translations.contactform.yourname}</label>
                                        ...
                                        <div>
                                            <label htmlFor="" className="text-base font-medium text-gray-900">{translations.contactform.email}</label>
                                            <div className="mt-2.5 relative">
                                        ...
                                        <div>
                                            <label htmlFor="" className="text-base font-medium text-gray-900"> {translations.contactform.phonenumber} </label>
                                            <div className="mt-2.5 relative">
                                        ...
                                        <div>
                                            <label htmlFor="" className="text-base font-medium text-gray-900"> {translations.contactform.companyname} </label>
                                            <div className="mt-2.5 relative">
                                                <input type="text" name="" id="" placeholder="Enter your full name" className="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="sm:col-span-2">
                                            <label htmlFor="" className="text-base font-medium text-gray-900"> {translations.contactform.message} </label>
                                            <div className="mt-2.5 relative">
