...
import InfiniteScrollButton from "./components/animations/InfiniteScrollButton";
  ...
  return (
    <>
      <Navbar translations={translations}/>
          ...
          {/*<InfiniteScrollButton  text="Envoyer" className="w-64 py-5" ></InfiniteScrollButton>*/}
              <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 z-20">
                  <div className="max-w-xl mx-auto text-center">
                      <h1 className="text-4xl font-bold sm:text-6xl">
                          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-gray-300">{translations.sectionhome.title}</span>
                      </h1>
                      <p className="mt-5 text-base text-black sm:text-xl">{translations.sectionhome.subtitle}</p>

                      <Link href={`/${currentLang}/contact`} target="_blank" title="book an appointment" className="inline-flex items-center px-6 py-4 mt-8 font-semibold text-white transition-all duration-200 bg-blue-600 rounded-lg sm:mt-16 hover:bg-blue-700 focus:bg-blue-700" role="button">
                      ...
                      <div className="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                          <div className="flex items-center">
                              ...
                              <p className="ml-3 text-sm text-black">{translations.sectionhome.text1}</p>
                          </div>
                          ...
                          <div className="flex items-center">
                              <svg className="flex-shrink-0" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path
                                      ...
                                      strokeLinejoin="round"
                                  />
                                  <path d="M7 12.6667L9.25 15L16 8" stroke="blue" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                              </svg>
                              <p className="ml-3 text-sm text-black">{translations.sectionhome.text2}</p>
                          </div>

                          <div className="flex items-center">
                              <svg className="flex-shrink-0" width="20" height="24" viewBox="0 0 20 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M17 11H3C1.89543 11 1 11.8954 1 13V21C1 22.1046 1.89543 23 3 23H17C18.1046 23 19 22.1046 19 21V13C19 11.8954 18.1046 11 17 11Z" stroke="blue" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                  <path d="M10 19C11.1046 19 12 18.1046 12 17C12 15.8954 11.1046 15 10 15C8.89543 15 8 15.8954 8 17C8 18.1046 8.89543 19 10 19Z" stroke="blue" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                  <path
                              ...
                              <p className="ml-3 text-sm text-black">{translations.sectionhome.text3}</p>
                          </div>
                      </div>
                  </div>
              </div>
